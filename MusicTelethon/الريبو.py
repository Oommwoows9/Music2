...
⧉ | لتشغيل الرقيه في المكالمة أرسل ⇦ [ `{HNDLR}تشغيل  + الرقيه` ]
...
⧉ | لتحميل صوتية أرسل ⇦ [ `{HNDLR}تحميل + اسم الصوتيه او الرابط` ]
⧉ | لتحميل فيديو  ⇦  [ `{HNDLR}تحميل_فيديو + اسم الصوتيه او الرابط` ]
———————×———————
